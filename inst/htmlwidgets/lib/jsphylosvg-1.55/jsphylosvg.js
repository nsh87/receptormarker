...
Smits.PhyloCanvas.NexmlParse.prototype = {
	...
	Rectangular : {
		bufferX			: 180, 			// Reduces the available canvas space for tree branches, allowing
...
Smits.PhyloCanvas.Render.SVG.prototype = {
	...
	return function(sSvg, dataObject){
        ...
        // Reset firstBranch; without this the text will rotate on replot
        firstBranch = true;
...
Smits.PhyloCanvas.Render.Phylogram.prototype = {
	...
	return function(sSvg, dataObject, bufferRadius){
        ...
        // Rest firstBranch; without this, the text will rotate on next replot
        firstBranch = true;
